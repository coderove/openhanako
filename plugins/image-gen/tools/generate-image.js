...
export const parameters = {
  ...
  properties: {
    ...
    resolution: { type: "string", description: "统一分辨率档位：1k, 2k, 4k；由 adapter 映射为供应商最接近的尺寸" },
    quality:    { type: "string", description: "画质档位：low, medium, high, auto（由 adapter 映射为供应商参数）" },
